    ...
    <view>
        ...
        <navigator url="/pages/address/address?source=1" class="address-section">
            <view class="order-content">
                ...
                <view class="cen">
                    <view class="top">
                        <text class="name">{{orderAddress.username}}</text>
                        <text class="mobile">{{orderAddress.mobile}}</text>
                    </view>
                    <text class="address">{{orderAddress.address}} {{orderAddress.area}}</text>
                </view>
        ...
        <view class="yt-list">
            ...
            <view class="yt-list-cell desc-cell">
                ...
                <input class="desc" type="text" v-model="tempNote" placeholder="请填写备注信息"
