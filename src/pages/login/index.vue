...
<template>
  <view class="wrap">
    <view class="top"></view>
    <view class="content">
      <view class="title">欢迎登录{{ scenicSpot }}景区</view>
      ...
      <view class="u-margin-bottom-40" v-if="loginMethod == 'password'">
        <input
          ...
          placeholder="请输入登录密码"
        />
        <button @tap="login" :style="[inputStyle]" class="getCaptcha">
          登录
        </button>
      </view>
      ...
      <view class="u-margin-bottom-40" v-else>
        ...
        <button @tap="sendSms" :style="[inputStyle]" class="getCaptcha">
          获取短信验证码
        </button>
      </view>
      ...
      <view class="alternative">
        <view
          ...
          >密码登录</view
        >
        <view class="password" v-else @click="loginMethod = 'phone'"
          >短信登录</view
        >
