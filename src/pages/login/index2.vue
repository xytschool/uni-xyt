<template>
    <view class="wrap">
        ...
        <view class="content">
            ...
            <view v-else-if="loginMethod=='password'">
                <input class="u-border-bottom" type="password" v-model="tel" placeholder="请输入手机号"/>
            </view>

            <view class="alternative">
                <view class="password" @click="loginMethod='password'">密码登录</view>
